    ...
    <nav class="navbar navbar-inverse fixed-top" id="sidebar-wrapper" role="navigation" style="margin-top:80px;">
     <ul class="nav sidebar-nav">
       ...
       <!-- <li><a href="#team"></a></li> -->
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="card mb-4" style="height: 400px; margin-left :20px">
              <div class="card-body text-center">
                <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3.webp" alt="avatar"
                  class="rounded-circle img-fluid" style="width: 150px;">
                <h5 class="myinfo">{{$empinfo->emp_name}}</h5>
                <p class="text-muted mb-1">{{$empinfo->designation}}</p>
                <p class="text-muted mb-4">{{$empinfo->address}}</p>
          ...
          <div class="col-lg-8">
            <div class="card mb-4">
              <div class="card-body">
                <div class="row2">
                  <div class="col-sm-3">
                    <p class="mb-0" style="text-align:left;">Full Name</p>
                  </div>
                  <div class="col-sm-9">
                    <p class="text_muted mb-0" style="text-align:left;width:70%">{{$empinfo->emp_name}}</p>
                  </div>
                </div>
                <hr>
                ...
                <div class="row2">
                  <div class="col-sm-3" >
                    <p class="mb-0" style="text-align:left;">Email</p>
                  </div>
                  <div class="col-sm-9">
                    <p class="text_muted mb-0" style="text-align:left;width:70%">{{$empinfo->emp_email}}</p>
                  </div>
                </div>
                <hr>
                <div class="row2">
                  <div class="col-sm-3">
                    <p class="mb-0" style="text-align:left;">Contact Number</p>
                  </div>
                  <div class="col-sm-9">
                    <p class="text_muted mb-0" style="text-align:left;width:70%">{{$empinfo->emp_phone}}</p>
                  </div>
                </div>
                <hr>
                <div class="row2">
                  <div class="col-sm-3">
                    <p class="mb-0" style="text-align:left;">Employee Id</p>
                  </div>
                  <div class="col-sm-9">
                    <p class="text_muted mb-0" style="text-align:left;width:70%">{{$empinfo->emp_id}}</p>
                  </div>
                </div>
                <hr>
                ...
                <div class="row2">
                    <div class="col-sm-3">
                      <p class="mb-0" style="text-align:left;">Designation</p>
                    </div>
                    <div class="col-sm-9">
                      <p class="text_muted mb-0" style="text-align:left;width:70%">{{$empinfo->designation}}</p>
                    </div>
                  </div>
                  <hr>
                ...
                <div class="row2">
                  <div class="col-sm-3">
                    <p class="mb-0" style="text-align:left;">Address</p>
                  </div>
                  <div class="col-sm-9">
                    <p class="text_muted mb-0" style="text-align:left;width:70%">{{$empinfo->address}}</p>
                  </div>
                </div>
                <hr>
                ...
                <div class="row2">
                    <div class="col-sm-3">
                      <p class="mb-0" style="text-align:left;">Joining Date</p>
                    </div>
                    <div class="col-sm-9">
                      <p class="text_muted mb-0" style="text-align:left;width:70%">{{$empinfo->joining_date}}</p>
                    </div>
                  </div>
                  <hr>
                  ...
                  <div class="row2">
                    <div class="col-sm-3">
                      <p class="mb-0" style="text-align:left;">Blood Group</p>
                    </div>
                    <div class="col-sm-9">
                      <p class="text_muted mb-0" style="text-align:left;width:70%"></p>
                    </div>
                  </div>
                  <hr>
                  <div class="col-md-6">
                                <a class="btn btn-primary" href="{{url('/employee_edit_profile')}}">Edit Profile</a>  
                            </div>
