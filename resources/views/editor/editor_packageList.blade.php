    ...
    <body>
        <div class="main-container" style="min-height:600px;">
            ...
            <div class="dashboard-content" style="width:100%;">
                ...
                <a href="{{url('/editor_packageAdd')}}" class="btn btn-primary" style="float: right; margin: 50px 50px 0px 0px;">Create New Package</a>
                        <div class="overlay">
                    ...
                    <table id="example" class="table table-striped" style="width:80%; margin-left:200px;">
                        <thead>
                            <tr>
                                ...
                                <th><center>Image Content</center></th>
                                <th><center>Video Content</center></th>
                                <th></th>
                                <th></th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($data as $item)      
                                <tr>
                                    <td><p>{{$item->package_name}}</p></td>
                                    <td><p>{{$item->Package_value}}</p></td>
                                    <td><p>{{$item->image_ad_count}}</p></td>
                                    <td><p>{{$item->video_ad_count}}</p></td>
                                    
                                    <td> <a href="{{ url('/edit/'.$item->id) }}" class="btn btn-success">Edit</a>
                                                </td>

                                                <td> <a href="{{ url('/editor_delete_package/'.$item->id) }}" class="btn btn-danger">Delete</a>
                                                </td>
