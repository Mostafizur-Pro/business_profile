            ...
            <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg -mt-64">
                <div class="px-6">
                        ...
                        <div class="w-full lg:w-4/12 px-4 lg:order-3 lg:text-right lg:self-center">
                            <div class="py-6 px-3 mt-32 sm:mt-0">
                                <button class="bg-pink-500 active:bg-pink-600 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1 ease-linear transition-all duration-150" type="button">
                                    <a href="{{ url('admin/edit_profile', $data->id) }}">
                                        Edit
                                    </a>
                                </button>
                            </div>
                    ...
                    <div class="text-center mt-12">
                        ...
                        <div class="text-lg leading-normal mt-0 mb-2 text-blueGray-400 font-bold capitalize">
                    ...
                    <div class="mt-10 py-10 border-t border-blueGray-200 mx-10">
                        <h3 class="text-2xl font-semibold leading-normal mb-2 text-blueGray-700 mb-2">
                            {{ $data->admin_name }}
                        </h3>
                        <div class="mb-2 text-blueGray-600 capitalize">
                            <i class="fas fa-user-tag mr-2 text-lg text-blueGray-400"></i>
                            {{ $data->role }}
                        </div>
