    ...
    <nav class="navbar navbar-inverse fixed-top" id="sidebar-wrapper" role="navigation" style="margin-top:80px;">
     <ul class="nav sidebar-nav">
       ...
       <div class="sidebar-brand">
         <a href="#">Busineess Profile</a></div></div>
       <li><a href="#home">Profile Dashboard</a></li>
       ...
       <li><a href="#team">Payment</a></li>
        ...
        <div style="width:75%; min-height:200px; background-color: #ffffff; display: flex; margin:auto; border-radius: 15px;">
        ...
        <div class="row">
                                       <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <p> {{$userinfo->organization_name}}</p>
