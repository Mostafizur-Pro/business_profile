        ...
        <div class="container">
            <div class="screen" >
                <div class="screen__content" style="background-color:white;">
                    <form class="registration_form" encrypt="multipart/form-data" method="post" action="{{url('/employee_register_form_action')}}" onsubmit="return FormValidation(''); ">
                    {{csrf_field()  }} 
                    <div class="login__field">
                        ...
                        <div class="login__field">
                            <input type="text" class="login__input" placeholder="Full Name" name="emp_name">
                        </div>

                        <div class="login__field">
                            <input type="text" class="login__input" placeholder="Email Address" name="emp_email">
                        </div>
                        <div class="login__field">
                            <input type="text" class="login__input" placeholder="Phone Number" name="emp_phone">
                        </div>
                        <div class="login__field">
                            <input type="text" class="login__input" placeholder="Designation" name="designation">
                        </div>
                        <div class="login__field">
                        ...
                        <div class="login__field">
                            ...
                            <input type="text" class="login__input" placeholder="Joining Date" name="joining_date">
                        </div>
                        <div class="login__field">
                         
                            <input type="text" class="login__input" placeholder="Enter Password" name="password">
                        </div>
