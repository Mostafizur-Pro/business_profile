...
<body class="bg-gray-200 min-h-screen">
    <header>
        <div class="header-part py-4 px-8 flex justify-between items-center">
            ...
            <div>
                <a href="{{url('/empRegister')}}" class="btn btn-primary hover:bg-primary-700">
                    <span>Register</span>
                </a>
            </div>
        </div>
    ...
    <div class="flex flex-col md:flex-row justify-center items-center mx-auto">
        <section class="flex flex-col justify-center items-center bg-white p-8 rounded-lg shadow-md md:w-96">
            <form class="bg-white rounded-lg" action="{{ url('empLogin') }}" method="post">
                @csrf

                <h3 class="text-3xl font-semibold mb-4">Employee Login</h3>
                ...
                <p class="mt-5">Create new Account! <a class="text-blue-500 font-bold" href="{{url('/empRegister')}}">Please Register</a></p>
            </form>
