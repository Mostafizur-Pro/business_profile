        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu mt-5" aria-labelledby="productsDropdown">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="companiesDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Companies
                    </a>
                    <div class="dropdown-menu mt-5" aria-labelledby="companiesDropdown">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu mt-5" aria-labelledby="pagesDropdown">
                        <a class="dropdown-item" href="{{url('/newClientList')}}">Our New Client</a>
