                ...
                <div class="modal" role="dialog">
                    <div class="modal-box">
                        ...
                        <div class="flex gap-3 my-2">
                            <input type="text" name="facebook" placeholder="" value="facebook.com" class="hidden ">
                        ...
                        <div class="flex gap-3 my-2">
                            <input type="text" name="twitter" placeholder="" value="twitter.com" class="hidden ">
                        ...
                        <div class="flex gap-3 my-2">
                            <input type="text" name="instagram" placeholder="" value="instagram.com" class="hidden ">
                        ...
                        <div class="flex gap-3 my-2">
                            <input type="text" name="linkedin" placeholder="" value="linkedin.com" class="hidden ">
