    ...
    <body>
        <div class="main-container" style="min-height:600px;">
            ...
            <div class="dashboard-content" style="width:100%;">
                ...
                <a href="{{url('/packageAdd')}}" class="btn btn-primary" style="float: right; margin: 50px 50px 0px 0px;">Create New Package</a>
                            ...
                            @foreach ($data as $item)      
                                <tr>
                                    ...
                                    <td> <a href="{{ url('/edit/'.$item->id) }}" class="btn btn-success">Edit</a>
                                                ...
                                                <td> <a href="{{ url('/packagedelete/'.$item->id) }}" class="btn btn-danger">Delete</a>
                                                </td>
