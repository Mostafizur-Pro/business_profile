        ...
        <div class="container">
            <div class="screen" >
                <div class="screen__content" style="background-color: white;">
                    <form class="registration_form" encrypt="multipart/form-data" method="post" action="{{url('update-data/'.$edit->id)}}" onsubmit="return FormValidation(''); ">
                    {{csrf_field()  }} 
                    ...
                    <form action="{{url('/edit_profile')}}" method="get" autocomplete="off">
