            ...
            <div class="card p-3 mb-3 h-100">
                <div class="d-flex justify-content-between">
                    <div class="d-flex flex-row align-items-center">
                        <div class="icon">
                            <img src="{{ asset($item->owner_image) }}" alt="" width="80" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                        </div>
                        <div class="ms-2 c-details text-start">
                            <h4 class="mb-0">{{$item->owner_name}}</h4>
                            <p>{{$item->owner_number}}</p>
                        </div>
                    </div>
                </div>
                <div class="mt-5">
                    ...
                    <div class="mt-5 text-start">
                        <div class="mt-3">
                            <h5 class="text1"><strong>Email:</strong> <span class="text2">{{$item->owner_email}}</span></h5>
                        </div>
                        <div class="mt-3">
                            <h5 class="text1"><strong>Address:</strong> <span class="text2">{{$item->owner_address}}</span></h5>
                        </div>
                        <div class="mt-3">
                            <h5 class="text1"><strong>Employee ID:</strong> <span class="text2">{{$item->emp_id}}</span></h5>
                        </div>
                    </div>
                </div>
                <div class="mt-auto">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title fs-5 text-uppercase fw-bold" id="exampleModalLabel">{{$item->owner_name}}</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body text-start">
                                <!-- User Profile Image -->
                                <img src="{{ asset($item->owner_image) }}" class="img-thumbnail" width="200" alt="Profile Picture">

                                <!-- User Details -->
                                <div>
                                    <p class="text-capitalize my-0 mt-3"><strong>Organization Name:</strong> {{$item->organization_name}}</p>
                                    <p class="text-capitalize my-0"><strong>Contact Number:</strong> {{$item->owner_number}}</p>
                                    <p class="text-capitalize my-0"><strong>Business Type:</strong> {{$item->business_type}}</p>
                                    <p class="text-capitalize my-0"><strong>Address:</strong> {{$item->owner_address}}</p>
                                    <p class="text-capitalize my-0"><strong>E-mail:</strong> {{$item->owner_email}}</p>
