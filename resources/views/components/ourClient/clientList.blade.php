                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-start">
                                <!-- User Profile Image -->
                                <img src="/images/unused profile picture.png" class="img-thumbnail" width="200" alt="Profile Picture">

                                <!-- User Details -->
                                <div>
                                    <p class="text-capitalize my-0 mt-3"><strong>Organization Name:</strong> {{$item->organization_name}}</p>
                                    <p class="text-capitalize my-0"><strong>Contact Number:</strong> {{$item->contact_number}}</p>
                                    <p class="text-capitalize my-0"><strong>Business Type:</strong> {{$item->business_type}}</p>
                                    <p class="text-capitalize my-0"><strong>Address:</strong> {{$item->address}}</p>
                                    <p class="text-capitalize my-0"><strong>E-mail:</strong> {{$item->email}}</p>
                                    <p class="text-capitalize my-0"><strong>E-mail:</strong> {{$item->employee_id}}</p>
