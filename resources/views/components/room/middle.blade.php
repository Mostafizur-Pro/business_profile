<div class="card border my-10 bg-base-100 shadow-xl">
    ...
    <figure class="mb-5"><img class="w-[80%] rounded-2xl" src="/assets/images/anondo confectionary.png" alt="Shoes" /></figure>
    ...
    <div class="flex items-center justify-between px-8 py-5">
        <div class="flex items-center mr-5">
            ...
            <div class="mr-2 ">
                <a href="javascript:void(0)" class="dark:hover:text-primary hover:text-primary transition-colors duration-200 ease-in-out text-[1.075rem] font-medium dark:text-neutral-400/90 text-secondary-inverse">Dan <span class="text-stone-500">and</span> Elise </a>
                <span class="text-stone-400 dark:text-stone-500 font-medium block text-[0.85rem]">liked this</span>
            </div>
        </div>
        <a class="inline-flex relative items-center group justify-end text-base font-medium leading-normal text-center align-middle cursor-pointer rounded-[.95rem] transition-colors duration-150 ease-in-out text-dark bg-transparent shadow-none border-0" href="javascript:void(0)">
            <span class="leading-none transition-colors duration-200 ease-in-out peer shrink-0 group-hover:text-primary text-secondary-dark">
