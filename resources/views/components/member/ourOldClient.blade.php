<div class="container mx-auto flex justify-between items-center">
  ...
  <!-- Search Option -->
  <form action="{{ url('members/our-old-clients') }}" method="GET" class="flex items-center ml-4">
      ...
      <div class="mb-6 border rounded-xl ">
        <div class="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
          ...
          <div class="p-6">
            ...
            <p class="mb-4 text-neutral-500 dark:text-neutral-300">{{$item->contact_number}}</p>
            ...
            <div class="modal" role="dialog">
              <div class="modal-box">
                ...
                <div class="text-left">
                  ...
                  <p class="pt-2"><strong>Contact Number:</strong> {{$item->contact_number}}</p>
                  <p class="pt-2"><strong>Business Type:</strong> {{$item->business_type}}</p>
                  <p class="pt-2"><strong>Address:</strong> {{$item->address}}</p>
                  <p class="pt-2"><strong>Email:</strong> {{$item->email}}</p>
                  <p class="pt-2"><strong>Employee ID:</strong> {{$item->employee_id}}</p>
                </div>
