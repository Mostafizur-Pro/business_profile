    ...
    <div class="w-full lg:flex items-center  gap-6 mt-10">
        <div class="lg:w-1/3">
            <div class="bg-white   border rounded-md border-gray-200 dark:border-gray-700  relative sm:p-10 p-6" style="border-radius:10px 60px ">
                ...
                <p class="text-base leading-6 text-gray-600   mt-4">When our designs need an expert opinion or approval, I know I can rely on your agency Thank you for all your help-I will be recommending you to everyone</p>
