            ...
            <li>
                ...
                <div class="overflow-hidden transition-all duration-200 ease-in-out" style="max-height: 264px;">
                    <ul class="pl-6 mt-2 list-none">
                        <!-- Landing -->
                        <li>
                            <a href="/empDashboard" class="text-sm relative py-2.7 pl-4 my-2 flex items-center px-4 font-medium">
                                <span>Profile</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ url('edit_empInfo_profile', $empData->id) }}" class="text-sm relative py-2.7 pl-4 my-2 flex items-center px-4 font-medium">
                                <span>Setting</span>
                            </a>
                        </li>
                        <!-- Landing -->
                        ...
                        <!-- Smart Home -->
                        <li>
                            <a href="/userInfo_emp" class="text-sm relative py-2.7 pl-4 my-2 flex items-center px-4 font-medium">
