        ...
        <ul class="flex flex-col space-y-2 mt-4 pl-0 list-none">
            <div class="overflow-hidden transition-all duration-200 ease-in-out">
                <ul class="menu pl-6 mt-2 list-none">
                    <!-- Dashboard -->
                    <li>
                        <a href="/employee/dashboard" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                    ...
                    <li>
                        <details close>
                            ...
                            <ul>
                                <li>
                                    <a href="/employee/dashboard" class="text-base text-gray-900 transition duration-75 pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Profile</a>
                                </li>
                                <li>
                                    <a href="{{ url('/employee/edit_empInfo_profile', $empData->id) }}" class="text-base text-gray-900 transition duration-75 pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Settings</a>
                                </li>
                            </ul>
                        </details>
                    </li>
                    ...
                    <li>
                        <details close>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="/employee/userInfo_emp" class="text-base text-gray-900 transition duration-75 pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Our Clients</a>
                                </li>
                    ...
                    <li>
                        <details close>
                            ...
                            <ul>
                                <li>
                                    <a href="/employee/packageItem" class="text-base text-gray-900 transition duration-75 pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Package List</a>
                                </li>
