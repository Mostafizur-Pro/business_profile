                    ...
                    <label tabindex="0" class="">
                        <a class="text-sm relative py-2.7 pl-4 my-2 flex items-center px-4 font-medium">
                            <div type="button" class="relative inline-flex items-center px-5  text-sm font-medium text-center   rounded-lg ">
                                ...
                                <div class="{{ count($pendingData) > 0 ||  count($deleteData) > 0 ? 'notification' : '' }} absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-red-500 border-2 border-red-500 rounded-full -top-2 -right-2 dark:border-gray-900"> </div>
                                @endif
